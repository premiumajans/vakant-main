                        ...
                        <div className="ftco-footer-widget mb-4 col">
                            ...
                            <div className="block-23 mb-3">
                                <ul style={{
                                    ...
                                    <li><span className="icon icon-map-marker"></span><span className="text">{settings?.find(item => item.name === 'address')?.link}</span>
                                    </li>
                                    <li><a href={`tel:${settings?.find(item => item.name === 'phone_1')?.link}`}><span className="icon icon-phone"></span><span className="text">{settings?.find(item => item.name === 'phone_1')?.link}</span></a>
                                    </li>
                                    <li><a href={`tel:${settings?.find(item => item.name === 'phone_2')?.link}`}><span className="icon icon-phone"></span><span className="text">{settings?.find(item => item.name === 'phone_2')?.link}</span></a>
                                    </li>
                                    <li><a href={`mailto:${settings?.find(item => item.name === 'email')?.link}`}><span className="icon icon-envelope"></span><span
                                        className="text">{settings?.find(item => item.name === 'email')?.link}</span></a></li>
                                </ul>
                            </div>
                            <ul className="ftco-footer-social list-unstyled float-md-center float-lft">
                                <li className="ftco-animate fadeInUp ftco-animated"><a href={settings?.find(item => item.name === 'facebook')?.link}><span
                                    className="icon-facebook"></span></a></li>
                                <li className="ftco-animate fadeInUp ftco-animated"><a href={settings?.find(item => item.name === 'instagram')?.link}><span
