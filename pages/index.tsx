                    ...
                    <div className="col-lg-12 pr-lg-5">
                        <div className="row justify-content-center pb-3">
                            <div data-aos="fade-up" className="col-md-12 head ing-section ">
                                <Link href={'/premium-jobs'} className="subheading">{t('premium')}</Link>
                                <h2 className="mb-4">{t('premium-job-posts')}</h2>
                            </div>
                        </div>
                        <div className="row">
                            {vacancies.filter(item => item.vacancy_type === 2).slice(0, 10).map(item => {
                                return <Link data-aos="fade-up" className="col-lg-4 col-md-6 col-12" key={item.id}
                                             href={"/job/" + item.id}>
                                    <div className="job-post-item p-4 d-block">
